...
class Engineer(Role):
    ...
    # goal: str = "Complete the function according to User Requirement. Generate a Python function to solve the given problem"
    goal: str = "Complete the function according to User Requirement. Generate a static Python function with the same input/output format as  User Requirement to solve the given problem"
