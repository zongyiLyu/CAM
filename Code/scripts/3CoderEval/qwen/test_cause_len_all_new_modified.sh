...
python /home/zlyuaj/Causal/MetaGPT/metagpt/software_causal_modified.py  \
    ...
    --original_result_path /home/zlyuaj/Causal/MetaGPT/output/CoderEval/results-CoderEval_qwen_original_dataset/CoderEval.jsonl \
    --original_result_workspace /home/zlyuaj/Causal/MetaGPT/workspace_qwen_CoderEval_original_result \
    --dataset ${dataset}\
