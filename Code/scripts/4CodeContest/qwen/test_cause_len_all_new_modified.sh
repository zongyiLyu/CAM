...
python /home/zlyuaj/Causal/MetaGPT/metagpt/software_causal_modified.py  \
    ...
    --original_result_path /home/zlyuaj/Causal/MetaGPT/output/codecontest/results-codecontest_qwen_original_dataset/codecontest.jsonl \
    --original_result_workspace /home/zlyuaj/Causal/MetaGPT/workspace_qwen_codecontest_original_result \
    --dataset ${dataset}\
