...
python /home/zlyuaj/Causal/MetaGPT/metagpt/software_causal_modified.py  \
    ...
    --original_result_path /home/zlyuaj/Causal/MetaGPT/output/codecontest/results-codecontest_deepseek-coder_original_dataset/codecontest.jsonl \
    --original_result_workspace /home/zlyuaj/Causal/MetaGPT/workspace_deepseek-coder_codecontest_original_result \
    --dataset ${dataset}\
